...
Declaring Multiple Variables at one time: 

```cpp
/*
Programmer Name: Noah Kuttler 
Description: Declaring Multiple Variables at one time
*/
...
int main() { 
    const int TAX_RATE = 0.067; 

    string firstName, lastName, fullName, star; 
    int starNum; 
    
    cout << "Enter your first name: " << endl; 
    getline(cin, firstName);  // User enters 'Noah' 
    cout << "Enter your last name: " << endl; 
    getline(cin, lastName); // User enters 'Kuttler'
    
    fullName = "Dr." + " " + firstName + " " + lastName; 
    
    starNum = fullName.length(); // length(); gets length of string
    star.assign(starnum, '*');
